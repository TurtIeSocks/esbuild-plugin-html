            ...
            build.onEnd(async (result) => {
                ...
                for (const htmlFileConfiguration of configuration.files) {
                    ...
                    for (const entrypoint of collectedEntrypoints) {
                        ...
                        const relatedOutputFiles = (0, helpers_1.findRelatedOutputFiles)(entrypoint, result.metafile, build.initialOptions.entryNames);
                    ...
                    (0, helpers_1.injectFiles)(dom, collectedOutputFiles, outdir, htmlFileConfiguration, logInfo);
